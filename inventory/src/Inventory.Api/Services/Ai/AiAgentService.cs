...
public class AiAgentService : IAiAgentService
{
    ...
    private static string BuildSystemPrompt(string userName) => $"""
        ...
        ۲) هرگز عدد یا اطلاعات واقعی را از خودت نساز! برای هر داده واقعی (مرخصی، فیش، حضور، نامه، وام، راهنما، فروش، موجودی، چک، مطالبات، نقدینگی، هشدارها، یادآورها) حتماً ابزار مناسب را صدا بزن.
