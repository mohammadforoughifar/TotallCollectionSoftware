...
{
    /// <summary>
    /// تنظیمات ساختار شماره نامه (اندیکاتور)، کد واحد سازمانی و افزایش طول شماره
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultDeptCode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    DefaultCompanyCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
