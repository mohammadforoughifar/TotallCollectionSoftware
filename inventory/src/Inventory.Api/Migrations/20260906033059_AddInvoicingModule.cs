...
/// <summary>
/// ماژول فاکتور: فاکتور خرید/فروش و برگشتی‌ها، اقلام فاکتور و پیکربندی انواع فاکتور.
/// عملیات به‌صورت SQL محافظت‌شده نوشته شده تا روی دیتابیس‌هایی که بخشی از این جداول را
/// از قبل دارند (اختلاف Snapshot با اسکیمای واقعی) بدون خطا اجرا شود.
/// </summary>
