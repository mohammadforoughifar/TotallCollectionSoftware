...
| **BonHr** (منابع انسانی بن‌سازه) | `Api/Modules/RadisHr/Controllers` (پیشوند `/radis-hr`) | `Api/Modules/RadisHr/Shared/Models` | Payroll/Attendance در همان پوشه | `Client/Pages/BonHr` در منوی مجموعه |
