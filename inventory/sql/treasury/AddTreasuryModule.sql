-- =====================================================================
-- ماژول خزانه‌داری — اسکریپت ایجاد جداول (idempotent)
--   TrsAccounts / TrsVouchers / TrsVoucherLines
--   TrsCheques  / TrsChequeActions / TrsRules
-- هر دستور با شرط وجود اجرا می‌شود؛ اجرای مکرر بی‌خطر است.
-- =====================================================================

IF OBJECT_ID(N'[TrsAccounts]', N'U') IS NULL
BEGIN
