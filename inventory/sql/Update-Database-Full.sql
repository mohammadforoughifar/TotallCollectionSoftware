...
-- ساختارهای قابل تنظیم ممکن است از طول قدیمی ۶۰ نویسه بیشتر شوند.
IF OBJECT_ID(N'dbo.InnerLetters', 'U') IS NOT NULL
BEGIN
    ALTER TABLE [InnerLetters] ALTER COLUMN [LetterNumber] nvarchar(400) NULL;
END;
GO
...
BEGIN
    CREATE TABLE [LetterNumberSettings] (
        ...
        [DefaultDeptCode] nvarchar(30) NULL,
        [DefaultCompanyCode] nvarchar(100) NULL,
